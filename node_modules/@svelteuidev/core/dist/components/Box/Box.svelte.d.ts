...
declare const __propDef: {
    props: {
        class?: string;
        root?: import("../../internal").LiteralUnion<keyof HTMLElementTagNameMap | {}, string>;
        css?: import("../../styles").CSS | ((theme: import("../../styles").SvelteUITheme) => import("../../styles").CSS);
        className?: string;
        override?: import("../../styles").CSS;
        element?: HTMLElement | import("svelte").SvelteComponent;
        ...
        'on:submit'?: import("svelte/elements").EventHandler<Event & {
            ...
            readonly submitter: HTMLElement;
        }, HTMLBaseElement> & import("svelte/elements").EventHandler<Event & {
            readonly submitter: HTMLElement;
